...
trips_col= trips_weather_94107[['id','start_station_id','end_station_id','mean_temperature_f','mean_humidity','mean_sea_level_pressure_inches',
...
trips3=trips2[['id','start_station_id','end_station_id','mean_temperature_f','mean_humidity','mean_sea_level_pressure_inches',
...
trips5=trips4[['id','mean_temperature_f','mean_humidity','mean_sea_level_pressure_inches',
...
df_nuevo.to_csv("testEditado8.csv", index=False)
