...
trips_col= trips_weather_94107[['duration','start_station_id','end_station_id','mean_temperature_f','mean_humidity','mean_sea_level_pressure_inches',
'mean_visibility_miles','precipitation_inches','mean_wind_speed_mph','max_gust_speed_mph']]

#############voy s buscar las 2 latitudes y longitudes################33
trips2=pd.merge(trips_col,stations,how='left',on=['start_station_id'])
trips3=trips2[['duration','start_station_id','end_station_id','mean_temperature_f','mean_humidity','mean_sea_level_pressure_inches',
'mean_visibility_miles','precipitation_inches','mean_wind_speed_mph','max_gust_speed_mph','lat','long']]
...
trips5=trips4[['duration','mean_temperature_f','mean_humidity','mean_sea_level_pressure_inches',
'mean_visibility_miles','precipitation_inches','mean_wind_speed_mph','max_gust_speed_mph','lat1','long1','lat','long']]
...
df_nuevo.to_csv("trainEditado8.csv", index=False)

print "\nCreado y guardado como trainEditado8.csv\n"
